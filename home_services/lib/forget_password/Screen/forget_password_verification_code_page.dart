...
import 'package:home_services/forget_password/Widget/send_verification_code.dart';
...
class ForgetPasswordVerificationCode extends StatefulWidget {
  ...
  ForgetPasswordVerificationCode({Key? key,required this.email,}) : super(key: key);

  @override
  State<ForgetPasswordVerificationCode> createState() => _ForgetPasswordVerificationCodeState();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(widget.email.text,style: const TextStyle(fontSize: 16),),
                Form(
                  child: Padding(
                ...
                ElevatedButton(
                  onPressed: (){
                    ...
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => ForgetPasswordSendCode(email: widget.email, code: widget.code)));
                  },
