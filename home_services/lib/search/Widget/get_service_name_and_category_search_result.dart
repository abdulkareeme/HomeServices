...
class GetServiceNameAndCategorySearchResult extends StatelessWidget {
  var user;
  TextEditingController titleController;
  String category;
  GetServiceNameAndCategorySearchResult({Key? key,required this.user,required this.titleController,required this.category}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        body: FutureBuilder(
          future: ob.titleAndCategorySearch(titleController, category),
